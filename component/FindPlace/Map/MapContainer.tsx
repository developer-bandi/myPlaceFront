...
function MapContainer({ setMapClick, mapClick }: MapContainerProps) {
  ...
  useEffect(() => {
    if (searchResult.length === 0 && searchMarker.length !== 0) {
  ...
  return <Map mapRef={mapRef} isMobile={isMobile}></Map>;
}
